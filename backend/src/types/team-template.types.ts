...
export interface TemplateRole {
  ...
  runtimeOverride?: 'claude-code' | 'gemini-cli' | 'codex-cli' | 'kimi-code' | 'crewly-agent';
...
export interface TeamTemplate {
  ...
  defaultRuntime: 'claude-code' | 'gemini-cli' | 'codex-cli' | 'kimi-code' | 'crewly-agent';
...
export function isValidTeamTemplate(value: unknown): value is TeamTemplate {
  ...
  if (!['claude-code', 'gemini-cli', 'codex-cli', 'kimi-code', 'crewly-agent'].includes(t.defaultRuntime as string)) return false;
